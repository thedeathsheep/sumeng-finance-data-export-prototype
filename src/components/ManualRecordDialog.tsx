      ...
      <div className="operation-body">
        ...
        <section className="form-section">
          ...
          <div className="form-grid">
            ...
            <label className="field"><span>收费单价标准</span><input value={draft.unitPriceStandard} placeholder="人工说明，例如：10 元 / 调用" onChange={(event) => update("unitPriceStandard", event.target.value)} /><small className="field-hint">仅作财务说明，不参与自动计算</small></label>
